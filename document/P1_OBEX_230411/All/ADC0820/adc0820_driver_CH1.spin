...
''set up the pins
              ...
              shl       datapins,#16           'datapins 16..23
              andn      dira,datapins
                 
              'cs to high         
              mov       cspin,#1     
              shl       cspin,#25              'cs pin 25
              or        dira,cspin
              or        outa,cspin
               
              'wr to high
              mov       wrpin,#1    
              shl       wrpin,#26              'wr pin 26
              or        dira,wrpin
              or        outa,wrpin
              
              'rd to high
              mov       rdpin,#1    
              shl       rdpin,#27              'rd pin 27
              or        dira,rdpin
              or        outa,rdpin

              mov       debugpin,#1    
              shl       debugpin,#0            'debugpin pin 1
              or        dira,debugpin
...
:loop
              ...
              shr       tmp1,#16              'shift level depends about input pins location
...
'=========================================================================================================                      
              ...
              shr       tmp2,#8               'shift level depends about input pins location
              or        tmp2,tmp1             'logic OR with two measured values  
              or        outa,rdpin            'rd to high, end conversion          
              waitcnt   target,twrLow_delay   'wait tp_delay  + add  twrLow_delay wr low time
              ''prop in idle next 500 ns

              ''start conversion fill third 8 bits from long
              andn      outa,wrpin            'wr low
              waitcnt   target,trdHi_delay    'wait wr low + prepare trdHi_delay
              ''prop in idle min 600ns
              or        outa,wrpin            'wr high
             ...
             ' shr       tmp2,#8               'no shift here its original location. modification nessecery if yoy want change pins location
              ...
              shl       tmp4,#8               'no shift here its original location
