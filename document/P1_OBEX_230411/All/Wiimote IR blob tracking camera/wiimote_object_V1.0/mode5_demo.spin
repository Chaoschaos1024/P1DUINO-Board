{{
This demo outputs all of the data available for all four blobs using mode 5.  Good for checking LED intensity and trying out
...
PUB start  |i,tempcnt ,xpos ,mody,blob
  ...
  repeat
     ...
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)
        text.dec(wii.getx(@out_data,5,blob))
     text.out($0D)
     ...
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)
        text.dec(wii.gety(@out_data,5,blob))
     text.out($0D)
     ...
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)     
        text.dec(wii.getsize(@out_data,5,blob))
     text.out($0D)

     text.str(string("xmin: "))      
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)     
        text.dec(wii.getxmin(@out_data,5,blob))
     text.out($0D)     

     text.str(string("ymin: "))
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)                
        text.dec(wii.getymin(@out_data,5,blob))
     text.out($0D)

     text.str(string("xmax: "))             
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)
        text.dec(wii.getxmax(@out_data,5,blob))        
     text.out($0D)

     text.str(string("ymax: "))
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)     
        text.dec(wii.getymax(@out_data,5,blob))
     text.out($0D)     
     ...
     repeat blob from 0 to 3
        text.out($0A)
        text.out((blob*8)+6)
        text.dec(wii.getintensity(@out_data,5,blob))
     text.out($0D)
